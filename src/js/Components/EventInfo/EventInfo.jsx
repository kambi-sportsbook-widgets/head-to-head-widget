...
const EventInfo = ({ homeName, homeScore, awayName, awayScore, start }) => {
  ...
  return (
    <div>
      <EventInfoContainer>
        <div
          className={styles.homeName + ' KambiWidget-card-support-text-color'}
        >
          {homeName}
        </div>
        ...
        <div
          className={styles.awayName + ' KambiWidget-card-support-text-color'}
        >
          {awayName}
        </div>
      </EventInfoContainer>
      {
        <div
          className={styles.eventName + ' KambiWidget-card-support-text-color'}
        >
          {formatedDate}
        </div>
      }
